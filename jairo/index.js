...
/*
  ...
  14. Escriba un programa JavaScript para convertir un número determinado en horas.
    ...
    let resultado = minuto / 60;
    console.log( minuto + " minutos es : "+ resultado + " horas");



    //2
    let minuto = 180;
    function Calcularminuto(minuto){
        return minuto/60;
    }
    console.log( minuto + " minutos , es " + Calcularminuto(minuto) + " horas");
    */